 ...
 *
 * The code is almost the same as in file bluesky-list-posts.php
 * but instead of app.bsky.feed.getAuthorFeed we use app.bsky.feed.getTimeline
 *
 * We show only original posts. We skip replies.
 *
...
if ( is_array( $session ) && !empty( $session ) && array_key_exists( 'accessJwt', $session ) ) {
	...
	curl_setopt_array(
		$curl,
		array(
			CURLOPT_URL => 'https://bsky.social/xrpc/app.bsky.feed.getTimeline?actor=' . $fetch_username . '&limit=' . $fetch_amount,
			CURLOPT_SSL_VERIFYPEER => false, // skip SSL because I don't have that in localhost
			CURLOPT_RETURNTRANSFER => true,
			CURLOPT_ENCODING => '',
			CURLOPT_FOLLOWLOCATION => true,
        ...
        (
            [record] => Array
                (
                    ...
                    [uri] => at://did:plc:qxddxevtvd6ow6zttzo32rct/app.bsky.feed.post/3kcf5qd5lhp2k
                    [cid] => bafyreic2tosv7wtqxzsydgj6sqmczryqtnrv46xwgsy7sbi2lpn4u2muty
                    [author] => Array
                        (
                            [did] => did:plc:qxddxevtvd6ow6zttzo32rct
                            [handle] => lorifreshwater.bsky.social
                            [displayName] => Lori Freshwater
                            [avatar] => https://cdn.bsky.app/img/avatar/plain/did:plc:qxddxevtvd6ow6zttzo32rct/bafkreigxy7ikczc4or5vriy2ueibhh225wdoo6rei2a2jhqc4t7uglzol4@jpeg
                            [viewer] => Array
                                (
                                    [muted] =>
                                    [blockedBy] =>
                    ...
                    [value] => Array
                        (
                            [text] => Mofo do. not. come. for. Wikipedia.
                            ...
                            [createdAt] => 2023-10-23T02:24:40.751Z
                        )
                    ...
                    [indexedAt] => 2023-10-23T02:24:39.445Z
                    [embeds] => Array
                        (
                        )
        ...
        (
            ...
            [images] => Array
                (
                    [0] => Array
                        (
                            [thumb] => https://cdn.bsky.app/img/feed_thumbnail/plain/did:plc:xfqcsi7wuwedeqaa5m7aih44/bafkreidtn6wfl3haxa5v54752sffxplqeygzar2sxbkdcipw6htlpeu64e@jpeg
                            [fullsize] => https://cdn.bsky.app/img/feed_fullsize/plain/did:plc:xfqcsi7wuwedeqaa5m7aih44/bafkreidtn6wfl3haxa5v54752sffxplqeygzar2sxbkdcipw6htlpeu64e@jpeg
                            [alt] =>
                            [aspectRatio] => Array
                                (
                                    [width] => 1037
